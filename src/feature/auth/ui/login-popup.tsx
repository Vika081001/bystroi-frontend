        ...
        <DialogContent className="sm:max-w-md rounded-2xl">
          ...
          >
            <div className="flex items-center gap-3 cursor-pointer">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center cursor-pointer">
            ...
            <div className="space-y-3">
              <Button 
                asChild
                className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 transition-all duration-300 hover:shadow-lg active:scale-[0.98] cursor-pointer rounded-full"
              >
              ...
              <Button 
                ...
                className="w-full border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700 hover:border-red-300 transition-all duration-300 active:scale-[0.98] cursor-pointer rounded-full"
              >
                Выйти из аккаунта
              </Button>
            </div>
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md rounded-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-center text-2xl font-bold text-blue-600 cursor-pointer">
            Вход в систему
          </DialogTitle>
        </DialogHeader>
          ...
          {testMode ? (
            ...
            >
              <div className="text-center cursor-pointer">
                <Sparkles className="w-12 h-12 mx-auto text-amber-500 mb-2 cursor-pointer" />
                <h3 className="text-lg font-semibold cursor-pointer">Быстрый тестовый вход</h3>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <CardContent className="p-4 flex flex-col items-center text-center">
                    <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center mb-3 transition-all duration-300">
                ...
                >
                  <CardContent className="p-4 flex flex-col items-center text-center">
                    <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mb-3 transition-all duration-300">
              ...
              <Input
                ...
                className="text-center text-lg transition-all duration-300 focus:ring-2 focus:ring-blue-500 cursor-pointer rounded-full"
              />
                ...
                <div className="border rounded-lg p-4 bg-yellow-50 cursor-pointer">
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      className="flex-1 bg-green-500 hover:bg-green-600 cursor-pointer rounded-full"
                      size="sm"
                    >
                    ...
                    <Button
                      ...
                      className="flex-1 bg-red-500 hover:bg-red-600 cursor-pointer rounded-full"
                      variant="destructive"
                      size="sm"
                    >
              ...
              <div className="space-y-3">
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 transition-all duration-300 hover:shadow-lg active:scale-[0.98] cursor-pointer rounded-full"
                >
                  Войти как продавец
                </Button>
              </div>
              ...
              <Button 
                ...
                className="w-full transition-all duration-300 hover:bg-gray-100 active:scale-[0.98] cursor-pointer rounded-full"
              >
            ...
            >
              <div className="flex gap-3 justify-around">
                <Button
                  onClick={() => setUserType("buyer")}
                  className={`rounded-full ${userType === "buyer" ? "bg-blue-500 text-white" : "bg-gray-500"} cursor-pointer`}
                >
                  Покупатель
                </Button>
                <Button
                  onClick={() => setUserType("seller")}
                  className={`rounded-full ${userType === "seller" ? "bg-green-500 text-white" : "bg-gray-500"} cursor-pointer`}
                >
                  Продавец
                </Button>
              </div>
                ...
                <div className="space-y-4">
                  <div className="relative">
                    <Input
                      ...
                      value={phone}
                      onChange={(e) => setPhone(e.target.value)}
                      className="pl-4 transition-all duration-300 focus:ring-2 focus:ring-blue-500 cursor-pointer rounded-full"
                    />
                  </div>
                  ...
                  {userType === "buyer" ? (
                    <div className="space-y-3">
                      <Input
                        ...
                        className="transition-all duration-300 focus:ring-2 focus:ring-blue-500 cursor-pointer rounded-full"
                      />
                      <Input
                        type="tel"
                        placeholder="Телефон"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="pt-2 cursor-pointer">
                        ...
                        <h4 className="font-medium mb-3 cursor-pointer">Ресурсы для продавцов</h4>
              ...
              <div className="text-center cursor-pointer">
                ...
                <Button 
                  ...
                  className="w-full border-amber-200 text-amber-600 hover:bg-amber-50 hover:border-amber-300 transition-all duration-300 active:scale-[0.98] cursor-pointer rounded-full"
                >
                  Тестовый вход (демо)
                </Button>
              </div>
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  className={`flex-1 ${mode === "login" ? "bg-blue-500 text-white" : "bg-gray-500"} cursor-pointer rounded-full`}
                >
                  Вход
                </Button>
                <Button
                  onClick={() => setMode("register")}
                  className={`flex-1 ${mode === "register" ? "bg-blue-500 text-white" : "bg-gray-500"} cursor-pointer rounded-full`}
                >
                  Регистрация
                </Button>
              </div>

              <div className="text-center text-xs text-gray-500 space-y-1 cursor-pointer">
                ...
                <p className="cursor-pointer">
                  ...
                  <a href="/terms" className="text-blue-600 hover:underline transition-colors duration-300 cursor-pointer">
