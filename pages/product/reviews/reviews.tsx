            ...
            <div className='flex pt-8 gap-8 flex-col lg:flex-row'>
                ...
                <div className='flex-1'>
                    <div className='flex gap-2 flex-wrap'>
                        <Badge variant="outline" className='h-7 border-blue-600 bg-blue-50 text-blue-600'>
                            Новые
                        </Badge>
                    ...
                    <div className='pt-8'>
                        ...
                        <div className='pt-4 grid grid-cols-5 gap-2 md:gap-4'>
                            <div className="aspect-square rounded-sm overflow-hidden">
                                <img src="https://picsum.photos/800/600" className='object-cover w-full h-full' alt="img" />
                            </div>
                            <div className="aspect-square rounded-sm overflow-hidden">
                                <img src="https://picsum.photos/800/600" className='object-cover w-full h-full' alt="img" />
                            </div>
                    ...
                    <div className='pt-8'>
                        ...
                        <ul className='flex flex-col gap-4 pt-6'>
                            <li>
                                ...
                                <div className='pt-1'>
                                    <p className='font-medium tracking-tight'>Отличный звук, отличный день!</p>
                                    <span className='text-sm text-gray-500'>
                                        AirPods 3 Pro Max Ultra
                                    </span>
                                    <p className='text-sm'>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam quasi reprehenderit quisquam eum recusandae, vero amet velit neque, explicabo exercitationem quas autem at suscipit ipsam culpa ratione iure, eius pariatur.
                                    </p>
                                </div>
                            ...
                            <li>
                                ...
                                <div className='pt-4 flex gap-2 items-center flex-wrap'>
                                    ...
                                    <Button variant="outline" size="sm">
                                        <ThumbsUp width={16} height={16} className='text-blue-600' />
                                        <span className='text-sm'>23 Понравилось</span>
                                    </Button>
                                    <Button variant="outline" size="sm">
                                        <ThumbsDown width={16} height={16} className='text-red-600' />
                                        <span className='text-sm'>5 Не понравилось</span>
                                    </Button>
                                </div>
                            </li>
                            <li className='pt-2'>
                                <Button variant="link" className='p-0 text-blue-600 cursor-pointer'>
                                    Все отзывы
                                </Button>
                            </li>
                        </ul>
