    ...
    return (
        <div className='xl:max-w-[280px] mx-auto max-w-lg w-full border border-gray-200 rounded-lg p-4 h-fit md:mt-12'>
            ...
            <div className='flex pt-4 justify-between items-center gap-2'>
                <div>
                    <p className='text-sm text-gray-500 inline-block'>Количество:</p> <span className='text-sm'>1</span>
                </div>
                <div className='max-w-32'>
                    <InputGroup>
                        <InputGroupInput defaultValue={1} className='text-center border border-gray-200' />
            ...
            <div className='flex pt-4 justify-between'>
                <button className='text-sm text-gray-600 flex items-center gap-1 '>
                    <Heart width={16} height={16} className='fill-gray-600' />
                    В Избранное
                </button>
                <button className='text-sm text-gray-600 flex items-center gap-1 '>
