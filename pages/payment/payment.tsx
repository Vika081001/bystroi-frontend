                    ...
                    <div className='flex flex-col-reverse gap-8 lg:grid grid-cols-7'>
                        <form action="" className='col-span-3'>
                            <Button className='w-full'>
                                <svg viewBox="0 0 50 20" fill="currentColor" className='!w-auto'>
                            ...
                            <div className='flex flex-col gap-6'>
                                ...
                                <div className='flex flex-col gap-1.5'>
                                    ...
                                    <Input id="number" type='number' required placeholder='+32 000 000 000' />
                                </div>
                                <div className='flex flex-col gap-1.5'>
                                    <Label htmlFor="delivery">Адрес доставки</Label>
                                    <Input id="delivery" type='text' required placeholder='улица пушкина дом калатушкина' />
                                </div>
                                <div className='flex flex-col gap-1.5'>
                                    <Label htmlFor="delivery">Примечание</Label>
                                    <Textarea id="delivery" required rows={10} placeholder='всякие нюансы' />
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox id="terms" checked={isChecked} onCheckedChange={(checked) => {
                                        setIsChecked(!!checked)
                                    }} />
                                    <Label htmlFor="terms">Заказ оформляется для другого человека</Label>
                                </div>
